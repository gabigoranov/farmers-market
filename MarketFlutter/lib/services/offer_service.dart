...
final class OfferService {
  ...
  Future<String> delete(int id) async {
    final url = 'https://192.168.100.6:8000/api/offers/$id';
  ...
  Future<String> edit(Offer offer) async {
    String url = 'https://192.168.100.6:8000/api/offer/${offer.id}';
  ...
  Future<void> getOffersData() async {
    ...
    String url = 'https://192.168.100.6:8000/api/offers';
  ...
  Future<List<Review>> loadOfferReviews(Offer offer) async {
    String url =
        'https://192.168.100.6:8000/api/reviews/by-offer/${offer.id}';
    Response<dynamic> response = await dio.get(url);
