...
class AppColors {
  static const Color backgroundWhite = Colors.white; // Light gray background
  static const Color backgroundDark = Color(0xff000114); // Light gray background
  static const Color containerLight = Colors.white; // Light container color
  static const Color containerDark = Color(0xff000114);
