...
class EditShoppingListItemView extends StatefulWidget {
  ...
  @override
  State<EditShoppingListItemView> createState() =>
          ...
          child: ListView(
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: OfferTypeService.instance.getOfferTypeNames().map((type) {
                ...
                onChanged: (newValue) {
                  if (newValue != null) {
                    setState(() {
                      _type = newValue;
                      _category = OfferTypeService.instance.getCategoryFromType(newValue);
                    });
                  }
                },
              ),
